...
namespace Common.Model
{
    public class DownloadModelObject : INotifyPropertyChanged, IDisposable
    {
        ...
        public bool RefreshWaitForLast { get; set; } = false;
        ...
        private void Timer_elapsed(object? sender, ElapsedEventArgs e)
        {
            ...
            if (!IsDownloading && RefreshWaitForLast && FileReceiver.AllPartsAreDownloaded)
            {
                CleanupRefresher();
                RefreshWaitForLast = false;
            }            
        }
