...
namespace Common.Model
{
   public class FlagMessagesGenerator
   {
      ...
      public static MethodResult GeneratePbftRequest(ISession session, string blockAsJson, string activeReplicasAsHash)
      {
         // Message has e parts: FLAG, BLOCK AS JSON, HASH OF ACTIVE REPLICAS
         byte[] request = GenerateMessage(SocketMessageFlag.PBFT_REQUEST, new object[] { blockAsJson, activeReplicasAsHash });
