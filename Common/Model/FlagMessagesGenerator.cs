...
namespace Common.Model
{
    public class FlagMessagesGenerator
    {
        ...
        public static MethodResult GeneratePbftRequest(ISession session, string blockAsJson)
        {
            // Message has 2 parts: FLAG, BLOCK AS JSON
            byte[] request = GenerateMessage(SocketMessageFlag.PBFT_REQUEST, new object[] { blockAsJson });
