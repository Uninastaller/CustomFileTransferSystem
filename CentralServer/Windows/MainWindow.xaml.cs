...
namespace CentralServer.Windows
{
    ...
    public partial class MainWindow : BaseWindowForWPF
    {
        ...
        public ServerSocketState CentralServerSocketState
        {
            ...
            private set
            {
                if (_centralServersocketState != value)
                {
        ...
        public MainWindow()
        {
            ...
            _serverBussinesLogic = new SslServerBussinessLogic(sslContext, _serverIpAddress, _serverPort, this, 0x2000, 0x2000, typeOfSession: TypeOfSession.SESSION_WITH_CENTRAL_SERVER);
        ...
        private async void OfferingFilesReceivedMessageHandler(List<OfferingFileDto> offeringFilesDto)
        {
            ...
            {
                await SqliteDataAccessOfferingFiles.InsertOrUpdateOfferingFileDtoAsync(offeringFileDto);
            }
        }
        ...
        private async void RequestForOfferingFilesMessageHandler(Guid sessionID)
        {
            ...
            if (session != null)
            {
                List<OfferingFileDto> offeringFiles = await SqliteDataAccessOfferingFiles.GetAllOfferingFilesWithEndpointsAsync();
