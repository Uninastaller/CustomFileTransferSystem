...
namespace SslTcpSession.BlockChain
{
    public class Blockchain
    {
        ...
        public async Task<BlockValidationResult> Add_AddCredit(double creditValueToAdd)
        {
        ...
        public async Task<BlockValidationResult> Add_AddFile(Guid fileId, string fileHash, IpAndPortEndPoint myEndPoint)
        {
        ...
        public async Task<BlockValidationResult> Add_RemoveFile(Guid fileId, string fileHash, IpAndPortEndPoint endPointToRemove)
        {
        ...
        public async Task<BlockValidationResult> Add_AddFileRequest(string fileHash)
        {
        ...
        public async Task<BlockValidationResult> Add_RemoveFileRequest(Guid fileId)
        {
        ...
        private async Task<BlockValidationResult> SendToPrimaryReplica(Block newBlock, Node fromNode)
        {
        ...
        private bool TryToChooseViewPrimaryReplica([MaybeNullWhen(false)] out Node leaderNode)
        {
