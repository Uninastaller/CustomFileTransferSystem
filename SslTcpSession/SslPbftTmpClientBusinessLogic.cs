...
namespace SslTcpSession
{
    public class SslPbftTmpClientBusinessLogic : SslClient, ISession
    {
        ...
        public static async Task<bool> SendPbftRequestAndDispose(IPAddress ipAddress, int port, string blockAsJson)
        {
            ...
            MethodResult result = FlagMessagesGenerator.GeneratePbftRequest(bs, blockAsJson);
